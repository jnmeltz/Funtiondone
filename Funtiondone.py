...
x = my_favorite_color("blue", "green")
...
def what_is_my_dogs_name(string1, string2):

    if string1 == string2:

        return "Yes, that's his name!"

    else:

        return "No, that's not his name."

x = what_is_my_dogs_name("Duke")
